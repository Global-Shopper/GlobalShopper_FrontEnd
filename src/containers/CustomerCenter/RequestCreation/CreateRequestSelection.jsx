			...
			<div className="max-w-7xl mx-auto px-6 py-12">
				...
				<div className="text-center mb-16">
					...
					<p className="text-l text-gray-500 max-w-4xl mx-auto">
						Chọn loại yêu cầu phù hợp để chúng tôi giúp bạn mua sắm
						hàng hóa từ các website quốc tế như Amazon, Taobao, eBay
						và nhiều hơn nữa.
					</p>
				</div>
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
						...
						>
							<CardContent className="p-8">
								...
								<p className="text-gray-600 text-center leading-relaxed mb-8">
									Dành cho sản phẩm nội địa nước ngoài không
									có sẵn link. Chúng tôi sẽ hỗ trợ tìm kiếm và
									mua hàng dựa trên thông tin bạn cung cấp.
								</p>
						...
						>
							<CardContent className="p-8">
								...
								<p className="text-gray-600 text-center leading-relaxed mb-8">
									Dành cho sản phẩm trên các sàn thương mại
									điện tử quốc tế như Amazon, eBay, Taobao. AI
									sẽ tự động trích xuất thông tin từ link.
								</p>
